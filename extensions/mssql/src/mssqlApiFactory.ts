...
import { IExtension, ICmsService, IDacFxService, ISchemaCompareService, MssqlObjectExplorerBrowser, ILanguageExtensionService, ISqlAssessmentService, ISqlMigrationService, IC2sService } from 'mssql';
...
export function createMssqlApi(context: AppContext, sqlToolsServer: SqlToolsServer): IExtension {
	return {
		...
		get c2s() {
			return context.getService<IC2sService>(constants.C2sService);
		}
	};
}
