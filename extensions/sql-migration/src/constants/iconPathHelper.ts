...
export class IconPathHelper {
	...
	public static testConnection: IconPath;
	...
	public static setExtensionContext(context: vscode.ExtensionContext) {
		...
		IconPathHelper.testConnection = {
			light: context.asAbsolutePath('images/testConnection.svg'),
			dark: context.asAbsolutePath('images/testConnection.svg')
		};
	}
}
