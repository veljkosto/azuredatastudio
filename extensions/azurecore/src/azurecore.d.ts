...
declare module 'azurecore' {
	...
	export interface IExtension {
		...
		getMigrationController(account: azdata.Account, subscription: azureResource.AzureResourceSubscription, resourceGroupName: string, regionName: string, ignoreErrors?: boolean): Promise<GetMigrationControllerResult>;
		/**
	...
	export type GetMigrationControllerResult = { controllers: azureResource.MigrationController[] | undefined, errors: Error[] };
