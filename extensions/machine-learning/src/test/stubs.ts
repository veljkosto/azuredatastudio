...
export class AzurecoreApiStub implements azurecore.IExtension {
	createResourceGroup(_account: azdata.Account, _subscription: azureResource.AzureResourceSubscription, _resourceGroupName: string, _requestBody: azureResource.CreateResourceGroupRequestBody, _ignoreErrors?: boolean): Promise<azurecore.CreateResourceGroupResult> {
