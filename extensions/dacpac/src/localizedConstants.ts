...
export const fileDoesNotExist = localize('dacfx.fileDoesNotExist', "File does not exist");
export const folderDoesNotExist = localize('dacfx.folderDoesNotExist', "Folder does not exist");
