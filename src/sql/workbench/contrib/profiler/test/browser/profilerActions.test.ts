...
import {
	ProfilerConnect, ProfilerStart, ProfilerCreate,
	ProfilerPause, ProfilerStop, ProfilerClear, ProfilerAutoScroll, ProfilerCollapsablePanelAction,
	ProfilerEditColumns, ProfilerFindNext, ProfilerFindPrevious, NewProfilerAction, ProfilerFilterSession, ProfilerClearSessionFilter
} from 'sql/workbench/contrib/profiler/browser/profilerActions';
...
suite('SQL QueryAction Tests', () => {
	...
	let editor1: TypeMoq.Mock<ProfilerEditor>;
	...
	setup(() => {
		...
		const contextkeyservice1 = new MockContextKeyService;

		editor1 = TypeMoq.Mock.ofType(ProfilerEditor, TypeMoq.MockBehavior.Strict, undefined, new TestThemeService(), undefined, undefined, undefined,
			contextkeyservice1, undefined);

		//code after this is for queryEditor.
