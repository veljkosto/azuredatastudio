...
import { ICellValue, IQueryMessage, ResultSetSubset, BatchSummary } from 'sql/workbench/services/query/common/query'; //BatchSummary should be added for restoreResults
